    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/75 backdrop-blur-sm p-4 sm:p-6 flex items-center justify-center animate-fade-in">
      <div className="relative w-full max-w-lg rounded-3xl bg-white dark:bg-[#0E1526] border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden my-auto">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                Student account access with optional provider sign-in.
              </p>
            </div>
          </div>
        ...
        <div className="p-6 space-y-5">
          ...
          {demoAccountsEnabled && activeTab === "PRESETS" && (
            <div className="space-y-4">
              <div className="text-xs text-slate-500 dark:text-slate-400">
                Demo accounts are available only in explicitly enabled non-production environments.
              </div>
          ...
          {activeTab === "SSO" && (
            <div className="space-y-3">
              ...
              <p className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 p-3 text-[11px] text-slate-500 dark:text-slate-400">
                Apple ID and campus NetID sign-in will appear here once their provider integrations are configured.
              </p>
            </div>
          )}
        </div>
